...
from src.token_utils import get_token_encoder


def num_tokens(text: str, token_encoder: Any | None = None) -> int:
    """Return the number of tokens in the given text."""
    if token_encoder is None:
        token_encoder = get_token_encoder(encoding_name="cl100k_base")
...
def chunk_text(
    text: str, max_tokens: int, token_encoder: Any | None = None
):
